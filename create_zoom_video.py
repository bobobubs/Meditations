...
def create_zoom_video_with_audio(image_path, audio_path, video_path):
    start_box, end_box = get_boxes(image_path)  # Call get_boxes internally
    ...
    out = cv2.VideoWriter(temp_video_path, fourcc, 30.0, (frame_width, frame_height))
